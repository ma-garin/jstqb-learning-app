...
document.addEventListener('DOMContentLoaded', () => {
    ...
    currentQuestionIndex = parseInt(localStorage.getItem('quizNextIndex') || '0', 10);
    ...
    function submitAnswer() {
        ...
        if (answerSummaryEl) {
            ...
            const lines = [
                { label: 'あなたの選択: ', value: formatLabel(userAnswer, q) },
                { label: '正解: ', value: formatLabel(correctAnswer, q) },
            ];
        ...
        localStorage.setItem('quizNextIndex', String(currentQuestionIndex + 1));
